...
<c:set var="pageTitle" value="Verify Registration OTP | CP Portal" scope="request"/>
                ...
                <article class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            <span class="badge rounded-pill text-bg-success px-3 py-2 mb-3">Registration OTP</span>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/register/verify">
                            ...
                            <button class="btn btn-success btn-lg w-100 rounded-3 shadow-sm" type="submit">Verify OTP</button>
                        </form>

                        <form method="post" action="${pageContext.request.contextPath}/register/verify" class="mt-3">
